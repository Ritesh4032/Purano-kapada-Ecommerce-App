...
import 'package:flutter_ecommerce/views/profile.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Image.asset('assets/products/purano2.png'),
        actions: [
          Padding(
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: const [
                    ...
                    ChipWidget(chipLabel: 'Gents'),
                    ChipWidget(chipLabel: 'Womens'),
                    ChipWidget(chipLabel: 'Childrens'),
                    ChipWidget(chipLabel: 'Donated'),
                  ],
                ),
              ),
              // Hot sales section
        ...
        onTap: (index) {
          if (index == 4) {
            Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      Profile()), // Navigate to the ProfilePage
            );
          } else {
            ref.read(currentIndexProvider.notifier).update(
                (state) => index); // Update the current index for other items
          }
        },
